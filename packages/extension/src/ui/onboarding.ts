...
export function ensureOnboardingBanner() {
  ...
  banner.innerHTML = `
    <strong style="display:block;margin-bottom:8px;font-size:16px">Welcome to Lumen Guardian</strong>
    <ol style="margin:0 0 8px 18px;padding:0">
      ...
      <li data-step="dashboard">
        Explore the Lumen Guardian dashboard to review alerts and QA tools.
        <div class="guardian-onboarding-status" style="font-size:12px;color:#facc15;margin-top:4px">Pending</div>
      </li>
    </ol>
